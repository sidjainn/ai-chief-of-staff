...
├── what-i-got-done/<YYYY>/<DATE>.md    # day-closer notes (gitignored, symlinked to private) — drafts in what-i-got-done/.drafts/ until reviewed
